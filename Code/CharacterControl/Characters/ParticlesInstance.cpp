...
//
//		PE_IMPLEMENT_CLASS1(ParticlesInstance, Component);
//
//		ParticlesInstance::ParticlesInstance(PE::GameContext& context, PE::MemoryArena arena, PE::Handle hMyself, Event_CreateParticlesInstance* pEvt) : Component(context, arena, hMyself)
//		{
//
...
//			StringOps::writeToString(pEvt->m_gameObjectId, m_gameObjectId, 32);
//			StringOps::writeToString(pEvt->m_target, pSoldierBehaviorSM->m_target, 32);
//			pSoldierBehaviorSM->m_haveTarget = StringOps::length(pSoldierBehaviorSM->m_target) > 0;
...
//		}
//
//		void ParticlesInstance::addDefaultComponents()
//		{
