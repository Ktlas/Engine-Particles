...
PE_IMPLEMENT_CLASS1(SoldierNPCMovementSM_Event_ROTATE_TO, Event);

SoldierNPCMovementSM_Event_ROTATE_TO::SoldierNPCMovementSM_Event_ROTATE_TO(Vector3 targetPos)
: m_targetPosition(targetPos)
{ }
...
void SoldierNPCMovementSM::addDefaultComponents()
{
	...
	PE_REGISTER_EVENT_HANDLER(SoldierNPCMovementSM_Event_ROTATE_TO, SoldierNPCMovementSM::do_SoldierNPCMovementSM_Event_ROTATE_TO);
...
void SoldierNPCMovementSM::do_SoldierNPCMovementSM_Event_ROTATE_TO(PE::Events::Event* pEvt)
{
	SoldierNPCMovementSM_Event_ROTATE_TO* pRealEvt = (SoldierNPCMovementSM_Event_ROTATE_TO*)(pEvt);
