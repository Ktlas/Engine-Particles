...
struct SoldierNPCMovementSM_Event_ROTATE_TO : public PE::Events::Event {
	PE_DECLARE_CLASS(SoldierNPCMovementSM_Event_ROTATE_TO);

	SoldierNPCMovementSM_Event_ROTATE_TO(Vector3 targetPos = Vector3());
...
struct SoldierNPCMovementSM : public PE::Components::Component
{
	...
	//
	PE_DECLARE_IMPLEMENT_EVENT_HANDLER_WRAPPER(do_SoldierNPCMovementSM_Event_ROTATE_TO)
		virtual void do_SoldierNPCMovementSM_Event_ROTATE_TO(PE::Events::Event* pEvt);
	//
