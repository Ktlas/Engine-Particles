	...
	// start root
	{
		...
		// start root.CharacterControl
		{
			...
			// start root.CharacterControl.Events
			{
				...
				//SoldierNPCAnimSM_Event_AIM_WALK::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
				SoldierNPCAnimSM_Event_STAND_SHOOT::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
				SoldierNPCMovementSM_Event_ROTATE_TO::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
