...
void Mesh::computeAxisAlignedBoundingBox() 
{
	PositionBufferCPU* posBuff = m_hPositionBufferCPU.getObject<PositionBufferCPU>();
	int numVertex = posBuff->m_values.m_size / 3;
	m_axisAlignedBoundingBox.m_Min.m_x = posBuff->m_values[0];
	m_axisAlignedBoundingBox.m_Max.m_x = posBuff->m_values[0];
	m_axisAlignedBoundingBox.m_Min.m_y = posBuff->m_values[1];
	m_axisAlignedBoundingBox.m_Max.m_y = posBuff->m_values[1];
	m_axisAlignedBoundingBox.m_Min.m_z = posBuff->m_values[2];
	m_axisAlignedBoundingBox.m_Max.m_z = posBuff->m_values[2];
	
	for (int i = 1; i < numVertex; i++) 
	{
		m_axisAlignedBoundingBox.m_Min.m_x = m_axisAlignedBoundingBox.m_Min.m_x < posBuff->m_values[i * 3] ? m_axisAlignedBoundingBox.m_Min.m_x : posBuff->m_values[i * 3];
		m_axisAlignedBoundingBox.m_Max.m_x = m_axisAlignedBoundingBox.m_Max.m_x > posBuff->m_values[i * 3] ? m_axisAlignedBoundingBox.m_Max.m_x : posBuff->m_values[i * 3];
		m_axisAlignedBoundingBox.m_Min.m_y = m_axisAlignedBoundingBox.m_Min.m_y < posBuff->m_values[i * 3 + 1] ? m_axisAlignedBoundingBox.m_Min.m_y : posBuff->m_values[i * 3 + 1];
		m_axisAlignedBoundingBox.m_Max.m_y = m_axisAlignedBoundingBox.m_Max.m_y > posBuff->m_values[i * 3 + 1] ? m_axisAlignedBoundingBox.m_Max.m_y : posBuff->m_values[i * 3 + 1];
		m_axisAlignedBoundingBox.m_Min.m_z = m_axisAlignedBoundingBox.m_Min.m_z < posBuff->m_values[i * 3 + 2] ? m_axisAlignedBoundingBox.m_Min.m_z : posBuff->m_values[i * 3 + 2];
		m_axisAlignedBoundingBox.m_Max.m_z = m_axisAlignedBoundingBox.m_Max.m_z > posBuff->m_values[i * 3 + 2] ? m_axisAlignedBoundingBox.m_Max.m_z : posBuff->m_values[i * 3 + 2];
	}
	PEINFO("Bounding box generated: %f, %f, %f, %f, %f, %f\n", m_axisAlignedBoundingBox.m_Min.m_x, m_axisAlignedBoundingBox.m_Min.m_y, m_axisAlignedBoundingBox.m_Min.m_z, m_axisAlignedBoundingBox.m_Max.m_x, m_axisAlignedBoundingBox.m_Max.m_y, m_axisAlignedBoundingBox.m_Max.m_z);
}
